...
export const INITIAL_SITES: SiteProfile[] = [
  ...
  },
  {
    ...
    notes: 'Downtown commercial and loft development property in Alpha Group.',
    latitude: 47.6090,
    longitude: -122.3350,
  ...
  },
  {
    ...
    accessGateNotes: 'Dock gate master key in Bravo route patrol lockbox.',
    status: 'active',
    createdAt: '2025-04-20T08:00:00Z',
    notes: 'Waterfront marina and public promenade in Bravo Group roving service.',
    latitude: 47.6105,
    longitude: -122.3500,
    geofenceRadiusMeters: 120,
    requireGeofence: true,
  ...
  },
  {
    ...
    notes: 'Public commercial plaza in Bravo Group roving patrol service.',
    latitude: 47.6140,
    longitude: -122.3515,
    geofenceRadiusMeters: 100,
    requireGeofence: true,
  ...
  },
  {
    ...
    notes: 'Multi-tenant research and tech campus in Charlie Group roving service.',
    latitude: 47.6380,
    longitude: -122.1890,
    geofenceRadiusMeters: 180,
    requireGeofence: true,
  ...
  },
  {
    ...
    accessGateNotes: 'Main lobby keycard override in Charlie box.',
    status: 'active',
    createdAt: '2025-04-28T08:00:00Z',
    notes: 'Medical office building in Charlie Group roving service.',
    latitude: 47.6210,
    longitude: -122.1860,
  ...
  },
  {
    ...
    notes: 'Logistics and freight staging yard in Echo Group roving service.',
    latitude: 47.5550,
    longitude: -122.3390,
    geofenceRadiusMeters: 200,
    requireGeofence: true,
  ...
  },
  {
    ...
    notes: 'Urban transit hub in Foxtrot Group roving service.',
    latitude: 47.6015,
    longitude: -122.3310,
    geofenceRadiusMeters: 90,
    requireGeofence: true,
...
export const INITIAL_COACHING_SESSIONS: GuardCoachingSession[] = [
  ...
  },
  {
    ...
    improvementOutcome: 'Measurable Improvement (+8 pts Oculus Score, zero report revisions requested)',
  ...
  },
  {
    ...
    guardName: 'Marcus Wright',
    guardBadge: 'SEC-6340',
    topic: 'Mobile Rover Circuit Optimization & CFS Intercept Dispatch',
    ...
    scoreDelta: 12,
    attendanceVerified: true,
    actionItems: ['Lead team briefing on Alpha Group roving stops', 'Maintain live telemetry link'],
  ...
  },
  {
    ...
    improvementOutcome: 'Substantial Improvement (+9 pts Oculus Score, expedited alarm triage)',
  ...
  },
  {
    ...
    improvementOutcome: 'Moderate Improvement (+7 pts Oculus Score, faster report submission)',
  ...
  },
  {
    ...
    improvementOutcome: 'Satisfactory Improvement (+6 pts Oculus Score, improved client interactions)',
