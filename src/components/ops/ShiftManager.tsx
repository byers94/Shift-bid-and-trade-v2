...
export const ShiftManager: React.FC = () => {
  ...
  const [statusFilter, setStatusFilter] = useState<'all' | 'open' | 'filled' | 'emergency'>('all');
  ...
  const hasActiveFilters = searchQuery.trim() !== '' || statusFilter !== 'all' || dateFilter !== '';
      ...
      <div className="flex-1 bg-white rounded-xl border border-slate-200 shadow-xs flex flex-col overflow-hidden min-h-0">
        ...
        <div className="p-3.5 border-b border-slate-100 flex flex-col gap-3 bg-slate-50/50 shrink-0">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
            ...
            {/* Date Quick Filter & Hide Filled Toggle */}
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 pt-1 border-t border-slate-200/60">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[11px] text-slate-500 font-medium">
                Showing <strong>{filteredShifts.length}</strong> of {shifts.length} shifts
              </span>
